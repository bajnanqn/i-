...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, sans-serif; }
        ...
        .brand-title { font-size: 1.2rem; font-weight: bold; }
        .badge-green {
...
<body>
    ...
    <div class="navbar">
        ...
        <div class="badge-green"><i class="fa-solid fa-circle"></i> Active System</div>
    </div>
    ...
    <div class="container">
        ...
        <div id="page-dashboard" class="page active">
            ...
            <div class="card">
                ...
                <div class="grid-2">
                    <div>
                        <small style="color:var(--text-sub)">Owner (₹300/ord)</small>
            ...
            <!-- Category Breakdown (Ledi Wear & Bebi Wear) -->
            <div class="card">
                <div class="card-header">
                    <span><i class="fa-solid fa-layer-group"></i> Category Breakdown</span>
                </div>
                <div class="grid-2">
            ...
            <!-- Next Delivery Card (Clickable to view details) -->
            <div class="card" style="margin-top: 15px;">
                <div class="card-header">
                    <span><i class="fa-solid fa-truck-fast"></i> Next Upcoming Delivery</span>
                </div>
        ...
        <!-- 2. ADD / EDIT ORDER PAGE -->
        <div id="page-add-order" class="page">
            <div class="card">
                <div class="card-header">
                    <span id="form-title"><i class="fa-solid fa-cart-plus"></i> Create Customer Order</span>
                </div>
                <form id="orderForm">
            ...
            <div class="card">
                <div class="card-header">
                    <span><i class="fa-solid fa-user-plus"></i> Add New Employee</span>
                </div>
                <div class="grid-2">
                    <input type="text" id="newEmpName" placeholder="Employee Name">
                    <input type="tel" id="newEmpPhone" placeholder="WhatsApp Number">
                </div>
                <button type="button" class="btn" style="background:var(--accent-blue); color:white;" onclick="addEmployee()"><i class="fa-solid fa-plus"></i> Add Tailor</button>
            </div>
        </div>
        ...
        <!-- 4. COMPLETED CUSTOMERS PAGE -->
        <div id="page-completed" class="page">
            <div class="card-header">
                <span><i class="fa-solid fa-circle-check" style="color:var(--accent-green)"></i> Completed Order History</span>
            </div>
            <div id="completed-orders-list"></div>
        </div>

        <!-- 5. MONTHLY REPORTS PAGE -->
    ...
    <div id="customerModal" class="modal">
        <div class="modal-content">
            ...
            <h3 id="modalCustName" style="color:var(--accent-green); margin-bottom: 5px;">Customer Name</h3>
            <p id="modalCustPhone" style="font-size: 0.85rem; color:var(--text-sub); margin-bottom: 15px;"></p>
            <h4 style="font-size:0.9rem; margin-bottom:10px;">Order History:</h4>
    ...
    <script>
        ...
        function calculateAdvanceHint() {
            ...
            if(cost > 0) {
                ...
                hintDiv.innerText = `Remaining Advance Balance (after cost): ₹${balanceAdv}`;
            } else {
                hintDiv.innerText = '';
            }
        }
        ...
        function saveOrder() {
            ...
            if(!name || !phone || !price || !date) return alert("Fill all required fields");
            ...
            if (editId) {
                ...
                const newOrder = {
                    ...
                    step: 1, // 1: Adv Paid, 2: Full Paid, 3: Completed
                    status: 'active'
                };
        ...
        function editOrder(id) {
            ...
            if (!order || order.step === 3) return alert("Cannot edit completed order!");
        ...
        function renderDashboard() {
            ...
            employees.forEach(emp => {
                ...
                empContainer.innerHTML += `
                    <div style="display:flex; justify-content:space-between; margin-bottom:8px; font-size:0.85rem;">
                        <span><i class="fa-solid fa-user-ninja"></i> ${emp.name} (${empOrders.length} work)</span>
            ...
            if(sortedDeliveries.length > 0) {
                ...
                nextDel.innerHTML = `<i class="fa-solid fa-user"></i> <b>${topOrder.name}</b> (${topOrder.category || 'Order'}) - <i class="fa-solid fa-calendar"></i> ${topOrder.date} <br><small style="color:var(--accent-green)">Click to view details</small>`;
        ...
        function advanceStatus(id) {
            ...
            if(order.step === 1) {
                order.step = 2; // Full Paid
            } else if(order.step === 2) {
                order.step = 3; // Stitch Paid & Completed
        ...
        function renderCompletedOrders() {
            ...
            if(Object.keys(customerMap).length === 0) {
                list.innerHTML = `<div style="color:var(--text-sub); text-align:center;">No completed history</div>`;
                return;
            }
            ...
            Object.values(customerMap).forEach(cust => {
                list.innerHTML += `
                    <div class="order-item" style="border-left-color: var(--accent-green); cursor:pointer;" onclick="showCustomerDetails('${cust.name}')">
                        <div class="order-header">
                            <span>${cust.name}</span>
                            <span style="color:var(--accent-green)"><i class="fa-solid fa-box-archive"></i> Total Orders: ${cust.orders.length}</span>
                        </div>
                        <div style="font-size:0.85rem; color:var(--text-sub);">
                            <div>Phone: ${cust.phone}</div>
                            <small style="color:var(--accent-blue)">Click to view full purchase history</small>
                        </div>
                    </div>
                `;
            });
        ...
        // Popup Customer Detailed History
